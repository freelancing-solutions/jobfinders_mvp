  ...
  return (
    <AppLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-slate-700 to-gray-800 text-white py-12 sm:py-20">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 text-center">
              <div className="flex flex-col items-center">
                <Briefcase className="h-10 w-10 sm:h-12 sm:w-12 text-slate-600 mb-2 sm:mb-4" />
              ...
              <div className="flex flex-col items-center">
                <Building2 className="h-10 w-10 sm:h-12 sm:w-12 text-emerald-600 mb-2 sm:mb-4" />
              ...
              <div className="flex flex-col items-center">
                <Users className="h-10 w-10 sm:h-12 sm:w-12 text-violet-600 mb-2 sm:mb-4" />
              ...
              <div className="flex flex-col items-center">
                <TrendingUp className="h-10 w-10 sm:h-12 sm:w-12 text-amber-600 mb-2 sm:mb-4" />
        ...
        {/* CTA Section */}
        <section className="py-12 sm:py-16 bg-gradient-to-r from-emerald-600 to-slate-700 text-white">
